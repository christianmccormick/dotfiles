...
_G._generate_user_statusline_highlights = function()
  ...
  local groups = {
    ...
    UserSLErrorBg = { fg = pal.error, bg = pal.sl.bg },
...
local c = {
  ...
  file_type = {
    provider = function()
      formatted_filetype = fmt("%s", vim.bo.filetype:upper())
      return formatted_filetype ~= "" and " " .. formatted_filetype .. " " or ""
    end,
    hl = "UserSLAlt",
  },
  fileinfo = {
  ...
  cur_percent = {
    provider = function()
      return " " .. require("feline.providers.cursor").line_percentage(nil, {}) .. "  "
    end,
    hl = vi_mode_hl,
  ...
  lsp_status = {
    provider = function()
      return vim.tbl_count(vim.lsp.get_clients()) == 0 and "" or " ◦ "
    end,
    hl = "UserSLStatus",
  ...
  lsp_error = {
    ...
    hl = "UserSLError",
    left_sep = { str = "", hl = "UserSLErrorBg", always_visible = true },
